    ...
    return (
      <>
        ...
        <div className='TripHeaderImageContainer'>
          {openMenu ?
            <button className='TripHeaderCloseMenuButton' onClick={handleCloseMenuClick}>
              <img src={CloseButton} alt="Fechar menu." />
            </button>
          :
            <button className='TripHeaderOpenMenuButton' onClick={handleOpenMenuClick}>
    ...
    return (
      <>
        <div className='TripMenuOptions'>
          <CRButton className='TripMenuOptionButton' onClick={handleHealthClick}>Minha saúde</CRButton>
          <CRButton className='TripMenuOptionButton' onClick={handleHistoryClick}>Histórico de viagens</CRButton>
          <CRButton className='TripMenuOptionButton' onClick={handleAchievementsClick}>Minhas conquistas</CRButton>
        </div>
        <div className='TripBar' />
        <div className='TripOptions'>
          <CRButton className='TripOptionButton' onClick={handleHealthClick}>Fazer parada</CRButton>
          <CRButton className='TripOptionButton' onClick={handleHistoryClick}>Finalizar viagem</CRButton>
        </div>
        <button className='TripHelp' onClick={handleHistoryClick}>
